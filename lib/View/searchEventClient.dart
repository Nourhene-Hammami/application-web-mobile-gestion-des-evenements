...
class SearchEventClient extends StatefulWidget {
   SearchEventClient({Key? key}) : super(key: key);

  @override
  SearchEventClientState createState() => SearchEventClientState();
}

class SearchEventClientState extends State<SearchEventClient> {
